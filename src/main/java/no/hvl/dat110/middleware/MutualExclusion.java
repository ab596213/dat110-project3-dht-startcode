...
public class MutualExclusion {
	...
	public boolean doMutexRequest(Message message, byte[] updates) throws RemoteException, NoSuchAlgorithmException {
	...
	public void onMutexRequestReceived(Message message) throws RemoteException {
		...
		if (node.getMessage().getNodeID().compareTo(message.getNodeID()) == 0) {
